...
void setup() {
  ...
  // create node
  RCCHECK(rclc_node_init_default(&node, "fingertip_force_id1", "", &support));
...
void loop() {
  ...
  float ADC_res = 4096.0;

  // Write new message
  msg.linear.x = posData.force_sensed_thumb/ADC_res;
  msg.linear.y = posData.force_sensed_index/ADC_res;
  msg.linear.z = posData.force_sensed_middle/ADC_res;
  msg.angular.x = posData.force_sensed_ring/ADC_res;
  msg.angular.y = posData.force_sensed_little/ADC_res;
  msg.angular.z = 42;
